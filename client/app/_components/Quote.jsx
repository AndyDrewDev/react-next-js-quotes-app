      ...
      <div className='flex flex-wrap mt-2'>
        {categories.map((category) => (
          <Link
            ...
            className={`${category === selectedCategory ? 'bg-violet-900 text-white' : 'bg-gray-200 text-gray-700 dark:bg-gray-700 dark:text-gray-300'} text-sm  px-2 py-1 rounded-full mr-2 mb-2`}
          >
            {category}
          </Link>
        ))}
